...
parser.add_argument('-v', '--video',
                    type=str,
                    help='D:/sensor_based_registration/camera_calibration results/Helmet_RGB/MHOC0025.mp4')
parser.add_argument('-d', '--dir',
                    type=str,
                    default='./cam1_images_helmet_rgb/',
...
def extract(path_video, path_images):
    ...
    images = []
    vidcap = cv2.VideoCapture("D:/sensor_based_registration/camera_calibration results/Helmet_RGB/MHOC0025.mp4")
